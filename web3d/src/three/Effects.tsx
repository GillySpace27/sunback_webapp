...
// is neutralized to a no-op (bokehScale 0) outside the aperture/darkroom window,
// rather than being added/removed — unmounting a pass rebuilds the composer and
// drops a frame at exactly the cinematic transitions jurors scrub over.
export default function Effects() {
  const dofActive = useStore((s) => s.progress > 0.46 && s.progress < 0.8);
