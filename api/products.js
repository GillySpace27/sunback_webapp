...
export const PRODUCTS = [
  ...
  { id: "rug_round", category: "home",            name: "Round Rug — 60″",     desc: "The Sun underfoot — 60″ round area rug",    icon: "fa-record-vinyl", price: "From $129.99", checkoutPrice: 12999, blueprintId: 1083, printProviderId: 10,  variantId: 81470, position: "front", aspectRatio: { w: 1, h: 1 }, printShape: "circle" },
  // ── Drinkware ──
  ...
  { id: "mug_15oz", category: "drink",             name: "Ceramic Mug — 15oz", desc: "Large ceramic mug, full-wrap print — white or black", icon: "fa-mug-hot", price: "From $14.99", checkoutPrice: 1499, blueprintId: 425,  printProviderId: 1,   variantId: 62014, position: "front", aspectRatio: { w: 2790, h: 1219 },
  ...
  { id: "mug_15oz_black", category: "drink",       name: "Ceramic Mug — 15oz (Black)", desc: "Large black ceramic mug, full-wrap print", icon: "fa-mug-hot", price: "From $14.99", checkoutPrice: 1499, blueprintId: 1152, printProviderId: 28,  variantId: 88132, position: "front", aspectRatio: { w: 2448, h: 1266 }, _hiddenFromGrid: true },
  ...
  { id: "tumbler_20oz", category: "drink",         name: "Tumbler — 20oz",      desc: "Insulated stainless steel with lid",        icon: "fa-glass-whiskey", price: "From $40.99", checkoutPrice: 4099, blueprintId: 353,  printProviderId: 1,   variantId: 44519, position: "front", aspectRatio: { w: 2795, h: 2100 } },
  // ── Apparel ──
  ...
  { id: "crewneck_sweatshirt", category: "apparel",  name: "Crewneck Sweatshirt", desc: "Unisex heavy blend crewneck",               icon: "fa-vest",         price: "From $34.99", checkoutPrice: 3499, blueprintId: 49,   printProviderId: 29,  variantId: 25377, position: "front", aspectRatio: { w: 3319, h: 3761 },
  ...
  { id: "phone_case_apple", category: "desk",     name: "Phone Case (iPhone)", desc: "Tough snap case — iPhone",                  icon: "fa-mobile-alt",   price: "From $19.99", checkoutPrice: 1999, blueprintId: 269,  printProviderId: 1,   variantId: 112814, position: "front", aspectRatio: { w: 1246, h: 2085 },
  ...
  { id: "phone_case_samsung", category: "desk",   name: "Phone Case (Samsung)", desc: "Tough snap case — Samsung Galaxy",         icon: "fa-mobile-alt",   price: "From $19.99", checkoutPrice: 1999, blueprintId: 269,  printProviderId: 1,   variantId: 125531, position: "front", aspectRatio: { w: 1251, h: 2097 },
  ...
  { id: "phone_case_pixel", category: "desk",     name: "Phone Case (Pixel)",  desc: "Tough snap case — Google Pixel",            icon: "fa-mobile-alt",   price: "From $24.99", checkoutPrice: 2499, blueprintId: 421,  printProviderId: 23,  variantId: 116386, position: "front", aspectRatio: { w: 1329, h: 2126 },
  ...
  { id: "laptop_sleeve", category: "desk",        name: "Laptop Sleeve",       desc: "Padded neoprene sleeve, snug fit",          icon: "fa-laptop",       price: "From $24.99", checkoutPrice: 2499, blueprintId: 429,  printProviderId: 1,   variantId: 62037, position: "front", aspectRatio: { w: 4, h: 3 } },
  ...
  { id: "mouse_pad", category: "desk",            name: "Mouse Pad",           desc: "Non-slip rubber base, smooth fabric top",   icon: "fa-mouse",        price: "From $20.99", checkoutPrice: 2099, blueprintId: 582,  printProviderId: 99,  variantId: 71665, position: "front", aspectRatio: { w: 1, h: 1 }, printShape: "circle" },
  { id: "desk_mat", category: "desk",             name: "Desk Mat",            desc: "Large-format mat for your workspace",       icon: "fa-desktop",      price: "From $24.99", checkoutPrice: 2499, blueprintId: 488,  printProviderId: 1,   variantId: 65240, position: "front", aspectRatio: { w: 5610, h: 3839 }, forceOrientation: "landscape" },
  // ── Home & Living ──
  ...
  { id: "throw_pillow", category: "home",         name: "Throw Pillow",        desc: "Spun polyester square pillow with insert",  icon: "fa-couch",        price: "From $22.99", checkoutPrice: 2299, blueprintId: 220,  printProviderId: 10,  variantId: 41521, position: "front", aspectRatio: { w: 1, h: 1 }, dualPanel: true, panelAspectRatio: { w: 4650, h: 2325 } },
  { id: "sherpa_blanket", category: "home",       name: "Sherpa Blanket",      desc: "Ultra-soft fleece with sherpa backing",     icon: "fa-cloud",        price: "From $44.99", checkoutPrice: 4499, blueprintId: 238,  printProviderId: 99,  variantId: 41656, position: "front", aspectRatio: { w: 7875, h: 9375 } },
  { id: "shower_curtain", category: "home",       name: "Shower Curtain",      desc: "Polyester shower curtain, vibrant print",   icon: "fa-shower",       price: "From $66.99", checkoutPrice: 6699, blueprintId: 235,  printProviderId: 10,  variantId: 41653, position: "front", aspectRatio: { w: 7104, h: 7392 } },
  ...
  // shows on the spine).
  { id: "journal_hardcover", category: "gifts",    name: "Hardcover Journal",   desc: "Matte hardcover, ruled pages",              icon: "fa-book",         price: "From $17.99", checkoutPrice: 1799, blueprintId: 485,  printProviderId: 28,  variantId: 65223, position: "front", aspectRatio: { w: 2032, h: 2850 }, dualPanel: true, panelAspectRatio: { w: 4065, h: 2850 } },
  ...
  // products.
  // { id: "backpack", category: "apparel",             name: "Backpack",            desc: "All-over print, padded straps",             icon: "fa-bag-shopping", price: "From $44.99", checkoutPrice: 4499, blueprintId: 347,  printProviderId: 14,  variantId: 44419, position: "front", aspectRatio: null }
  ...
  { id: "crew_socks", category: "apparel",           name: "Crew Socks",          desc: "All-over print socks — three lengths",      icon: "fa-socks",        price: "From $22.99", checkoutPrice: 2299, blueprintId: 365,  printProviderId: 14,  variantId: 44906, position: "front", aspectRatio: { w: 1358, h: 5551 } },
  // Magnets: die-cut, $4.83 (2") to $8.86 (6") (Printed Simply).
  { id: "magnet_diecut", category: "gifts",        name: "Die-Cut Magnets",     desc: "Fridge-ready Sun, 2″ to 6″",                icon: "fa-magnet",       price: "From $9.99",  checkoutPrice: 999,  blueprintId: 851,  printProviderId: 73,  variantId: 76775, position: "front", aspectRatio: { w: 1, h: 1 } },
  ...
  { id: "candle_soy", category: "gifts",           name: "Scented Candle",      desc: "9oz soy candle, nine scents",               icon: "fa-fire",         price: "From $27.99", checkoutPrice: 2799, blueprintId: 1048, printProviderId: 219, variantId: 80301, position: "front", aspectRatio: { w: 900, h: 600 } },
];

// ── Landing-grid organization (Gilly, 2026-08-08) ────────────────
// The flat popularity grid had grown to 35 cards (~8,900px tall).
// The grid now renders a curated "Most popular" top row followed by
// category groups; featured products appear ONLY in the top row
// (duplicate data-product-id nodes would break price-update queries).
export const FEATURED_PRODUCT_IDS = [
  "poster_matte", "canvas_stretched", "wall_clock",
  "metal_sign", "mug_15oz", "ornament_ceramic",
];
export const PRODUCT_CATEGORY_ORDER = [
  { key: "wall",    label: "Wall art" },
  { key: "home",    label: "Home & cozy" },
  { key: "drink",   label: "Drinkware" },
  { key: "apparel", label: "Apparel" },
  { key: "desk",    label: "Desk & tech" },
  { key: "gifts",   label: "Gifts & stationery" },
];
